...
def submit():
    ...
    if IBLength == 12:
        ...
        my_canvas.itemconfig(vartext, text= "EIN Accepted ", anchor = "nw", font = ("helvetica",15) ,fill= "green" )
        cond = 1
    elif IBLength == 10:
        ST = " EIN"
        EID = IBL
        EIDL.config(text ="SN is "+ EID , font =("Helvetica", 20), width = 20, fg = "black", bg ="green", bd = 0)
        my_canvas.itemconfig(vartext, text= "SN Accepted ", anchor = "nw", font = ("helvetica",15) ,fill= "green" )
        ...
        if IBL == "checkin" and cond2 == 1:
            ...
            EIDL.config(text ="SN " , font =("Helvetica", 20), width = 10, fg = "black", bg = "gray", bd = 0)
            EINL.config(text ="EIN " , font =("Helvetica", 20), width = 10, fg = "black", bg = "gray", bd = 0)    
            my_canvas.itemconfig(vartext, text= "Invalid Input ", anchor = "nw", font = ("helvetica",15) ,fill= "red" )
            cond = 0
            cond2 = 0
